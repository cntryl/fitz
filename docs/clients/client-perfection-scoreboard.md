...
| fitz-ts     | websocket | anonymous            | 100%         | 100%         | pass    | `fitz-ts/artifacts/conformance-ws-anonymous.json`                                | no        | No non-pass scenarios; CS-016 also covers typed filtered-read error handling   |
| fitz-ts     | websocket | valid_jwt            | 100%         | 100%         | pass    | `fitz-ts/artifacts/conformance-ws-valid_jwt.json`                                | no        | No non-pass scenarios; CS-016 also covers typed filtered-read error handling   |
| fitz-ts     | tcp       | anonymous            | 100%         | 100%         | pass    | `fitz-ts/artifacts/conformance-tcp-anonymous.json`                               | no        | No non-pass scenarios; CS-016 also covers typed filtered-read error handling   |
| fitz-ts     | tcp       | valid_jwt            | 100%         | 100%         | pass    | `fitz-ts/artifacts/conformance-tcp-valid_jwt.json`                               | no        | No non-pass scenarios; CS-016 also covers typed filtered-read error handling   |
...
| fitz-rs     | websocket | anonymous            | 100%         | 100%         | pass    | `fitz-rs/artifacts/conformance-ws-anonymous.json`                                | no        | No non-pass scenarios                                                          |
| fitz-rs     | websocket | valid_jwt            | 100%         | 100%         | pass    | `fitz-rs/artifacts/conformance-ws-valid_jwt.json`                                | no        | No non-pass scenarios                                                          |
| fitz-rs     | tcp       | anonymous            | 100%         | 100%         | pass    | `fitz-rs/artifacts/conformance-tcp-anonymous.json`                               | no        | No non-pass scenarios                                                          |
| fitz-rs     | tcp       | valid_jwt            | 100%         | 100%         | pass    | `fitz-rs/artifacts/conformance-tcp-valid_jwt.json`                               | no        | No non-pass scenarios                                                          |
...
| ------ | ------- | -------------------------------------- | -------- | ---------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | -------------------------------------- |
| MF-001 | fitz-rs | CS-001..CS-016                         | P0       | unassigned | closed | Route-shape bug, stub panic, missing cancellation/reconnect, WS Transport-kind handling; all fixed in conformance.rs | — | All 4 matrix legs: 100% P0, 100% P1, overall_status=pass |
