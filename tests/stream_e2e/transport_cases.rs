...
define_transport_tests!(
    ...
    should_reject_invalid_stream_subscription_patterns_tcp / should_reject_invalid_stream_subscription_patterns_ws => should_reject_invalid_stream_subscription_patterns,
    should_enforce_stream_wildcard_registration_limit_tcp / should_enforce_stream_wildcard_registration_limit_ws => should_enforce_stream_wildcard_registration_limit,
    should_deliver_stream_notification_for_overlapping_wildcards_tcp / should_deliver_stream_notification_for_overlapping_wildcards_ws => should_deliver_stream_notification_for_overlapping_wildcards,
);
