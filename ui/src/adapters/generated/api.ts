...
export const api = defineApi({
  ...
  listScheduleExecutionObservations: get("/api/v1/{family}/schedule/realms/{realm}/areas/{area}/resources/{resource}/executions")
    ...
    .errors({ "400": json<Error>(), "401": json<Error>(), "403": json<Error>(), "404": json<Error>(), "503": json<Error>() })
    .security([{"sessionCookie":[]}]),
  runScheduleNow: post("/api/v1/{family}/schedule/realms/{realm}/areas/{area}/resources/{resource}/operations/{operation}/run")
    .params<RunScheduleNowPath>({ "area": { style: "simple", explode: false }, "family": { style: "simple", explode: false }, "operation": { style: "simple", explode: false }, "realm": { style: "simple", explode: false }, "resource": { style: "simple", explode: false } })
    .returns(json<ScheduleRunNowResponse>())
    .errors({ "400": json<Error>(), "401": json<Error>(), "403": json<Error>(), "404": json<Error>(), "503": json<Error>() })
    .security([{"sessionCookie":[]}]),
