...
impl<K: KvStore> KvDomainStore<K> {
    ...
    pub fn scan(&self, route: &str, start_key: &str, limit: usize) -> Result<Vec<(String, Vec<u8>)>, String> {
    ...
    pub fn get_batch(&self, route: &str, keys: Vec<String>) -> Result<Vec<(String, Option<Vec<u8>>)>, String> {
