...
pub use transport::{
    ...
    build_schedule_create, build_schedule_create_batch, build_stream_append,
    build_stream_append_with_metadata, build_stream_begin, build_stream_commit,
    build_stream_get_metadata, build_stream_last, build_stream_read, build_stream_read_with_limit,
    build_stream_subscribe, count_stream_read_records_from_payload, ensure_schedule_ok,
