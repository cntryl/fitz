...
impl RealmActor {
    ...
    fn handle_request_realm_lease(
        ...
        LeaseGrant {
            area_start: 0,  // Will be filled by AreaActor grant
            area_end: 0,
            realm_start: start,
    ...
    fn handle_area_watermark_advanced(
        ...
        self.recalculate_realm_watermark();
    }
    
    /// Recalculate realm watermark as minimum of all area watermarks
    fn recalculate_realm_watermark(&mut self) {
        ...
        self.realm_watermark = *self.area_watermarks
            .values()
            .min()
            .unwrap_or(&0);
    }
