...
use keys_and_models::{
    ...
    COMPACT_AREA_PAGE_VALUE_V1_MARKER, COMPACT_REALM_PAGE_VALUE_V1_MARKER,
    COMPACT_RESOURCE_PAGE_VALUE_V1_MARKER, COMPRESSED_COMPACT_REALM_PAGE_VALUE_V1_MARKER,
    OPTIONAL_BYTES_ABSENT, OPTIONAL_OFFSET_ABSENT, REALM_LOCATOR_VALUE_V1_MARKER,
    REALM_VALUE_V2_MARKER, RESOURCE_VALUE_V2_MARKER, STREAM_LAYOUT_MARKER_VALUE_V1_MARKER,
};
...
pub use keys_and_models::{
    ...
    encode_offset_counter_key, encode_realm_counter_key, encode_realm_discriminator_key,
    encode_realm_key, encode_realm_locator_key, encode_realm_watermark_key,
    ...
    CompactAreaPageValue, CompactRealmPageRecord, CompactRealmPageValue, CompactResourcePageRecord,
